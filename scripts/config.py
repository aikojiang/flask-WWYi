...
class Config(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        self.openai_api_key = os.getenv("OPENAI_API_KEY","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")
        ...
        self.pinecone_api_key = os.getenv("PINECONE_API_KEY","d8883758-5f2c-4c93-9a2d-d87713f26d0b")
